...
function parse_perks(fixed, unlocks) {
	...
	var perks = {
		...
		Classy: new Perk(1e17, 0, mult(4.5678375), 100),
		Overkill: new Perk(1e6, 0, add(500), 200),
		...
		Anticipation: new Perk(1000, 0, add(6), 20),
		Resilience: new Perk(100, 0, mult(10)),
		Meditation: new Perk(75, 0, add(1), 20),
		Relentlessness: new Perk(75, 0, function (l) { return 1 + 0.05 * l * (1 + 0.3 * l); }, 20),
		Carpentry: new Perk(25, 0, mult(10)),
		Artisanistry: new Perk(15, 0, mult(-5)),
		Range: new Perk(1, 0, add(1), 20),
		Agility: new Perk(4, 0, mult(-5), 40),
